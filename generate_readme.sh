...
echo "15、[《2024-开源PolarDB|PostgreSQL 应用开发者&DBA 公开课》](202310/20231030_02.md)     "  >> ./README.md    
echo "16、[《2025-PolarDB 进阶课程, 穷鬼玩PolarDB RAC一写多读集群 系列文章》](202501/20250114_01.md)     "  >> ./README.md    
...
echo "19、[《2024-数据库筑基课 系列》](202409/20240914_01.md)     "  >> ./README.md    
...
echo "32、[《2025-大学生数据库实践课 : 大模型及Dify体验+AI搜索技术实践(向量、关键词、标量、图、以及混合搜索)》](202512/20251202_10.md)     "  >> ./README.md    
echo "33、[《2026-散户投资小白金融全品种操盘手册》](202605/20260528_03.md)      "  >> ./README.md  
echo "  "  >> ./README.md
...
echo "<a rel=\"nofollow\" href=\"http://info.flagcounter.com/h9V1\"  ><img src=\"http://s03.flagcounter.com/count/h9V1/bg_FFFFFF/txt_000000/border_CCCCCC/columns_2/maxflags_12/viewers_0/labels_0/pageviews_0/flags_0/\"  alt=\"Flag Counter\"  border=\"0\"  ></a>  " >> ./README.md
echo "  " >> ./README.md  
echo "[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/digoal/blog)" >> ./README.md  
echo "  " >> ./README.md  
