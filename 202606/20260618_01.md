...
**太长不看: 写 SKILL 和做规划的部分采用了较为复杂的国产模型 minimax M3; 写代码、review代码、写测试用例和测试、找BUG、写用户手册的部更耗费时间和Token, 则采用了高效且廉价的 step-3.7-flash ; 最终呈现堪称完美.**  
  
还有高级羊毛可以薅, 目前 step 在搞免费试用( https://platform.stepfun.com?invite_code=SIASEDCW ), 薅一下给小龙虾续命, 最长免费续命3个月.  
