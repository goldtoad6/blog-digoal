## 德说-第525期, 用 Antigravity (agy) 测完 gemini 3.6 flash 后, 谷歌还是王者  
...
新申请账号, 建议使用手机 youtube 客户端申请, 申请完 gamil 后, 第一次登陆需要授权, 使用启动了 youtube 的手机用相机扫码, 可在 youtube 端进行认证, 避免短信认证不通过的问题.  
```  
/model  
Switch Model  
